...
- [ ] **W1** (exploration-travel, 2026-09-16): The road is a scene — one prefix-stable clause: a journey between two named places gets one beat of the way with its bearing, duration, and road said in-world, and arrival is its own consequence; the DM `location` wire gets its missing annotation; fills phase-1 travel links that stay bare today — entry 2026-09-16
