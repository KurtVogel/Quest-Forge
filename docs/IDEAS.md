...
- **Receipt subject list noise** (cosmetic): place-name variants ("Saltmere Harbor, Harbormaster's Office, Saltmere harbor office…") pile up next to the person in the `📜 From the record for …` line — collapse variants of one record.
